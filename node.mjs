...
;
	($.$hyoo_slides_page) = class $hyoo_slides_page extends ($.$mol_book2) {
		speaker_tools(){
			return [];
		}
		uri_base(){
	...
	($mol_mem(($.$hyoo_slides_page.prototype), "Speaker_content"));
	($mol_mem(($.$hyoo_slides_page.prototype), "Speaker"));
	($mol_mem(($.$hyoo_slides_page.prototype), "Listener_content"));
	($mol_mem(($.$hyoo_slides_page.prototype), "Link"));
	($mol_mem(($.$hyoo_slides_page.prototype), "Progress"));
	($mol_mem(($.$hyoo_slides_page.prototype), "Listener"));
	($mol_mem(($.$hyoo_slides_page.prototype), "contents"));
	($mol_mem(($.$hyoo_slides_page.prototype), "slide"));
...
;
	($.$hyoo_slides) = class $hyoo_slides extends ($.$mol_view) {
		...
		Speech_toggle(){
			...
			(obj.checked) = (next) => ((this.speech_enabled(next)));
		...
		Paginator(){
			...
			(obj.value) = (next) => ((this.slide(next)));
			return obj;
		}
		open_listener_hint(){
		...
		Open_listener(){
			...
			(obj.arg) = () => ({"role": "listener", "slide": null});
		...
		Nav(){
			...
			(obj.current_y) = (next) => ((this.slide(next)));
			(obj.current_x) = (next) => ((this.slide(next)));
			return obj;
		}
		event_next(next){
			if(next !== undefined) return next;
		...
		Touch(){
			...
			(obj.swipe_to_left) = (next) => ((this.event_next(next)));
			(obj.swipe_to_right) = (next) => ((this.event_prev(next)));
			return obj;
		}
		speech_next(){
			return [
		...
		Speech_next(){
			...
			(obj.event_catch) = (next) => ((this.event_next(next)));
		...
		Speech_slide(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_slide(next)));
		...
		Speech_prev(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_prev(next)));
		...
		Speech_start(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_start(next)));
		...
		Speech_end(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_end(next)));
		...
		Speech_about(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_about(next)));
		...
		Speech_repeat(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_repeat(next)));
		...
		Speech_on(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_speech_on(next)));
		...
		Speech_off(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_speech_off(next)));
			(obj.patterns) = () => ((this.speech_off()));
			return obj;
		}
		event_lights_toggle(next){
			if(next !== undefined) return next;
			return null;
		}
		lights_toggle(){
		...
		Lights_toggle(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_lights_toggle(next)));
		...
		Sing(){
			const obj = new this.$.$mol_speech();
			(obj.event_catch) = (next) => ((this.event_sing(next)));
			(obj.patterns) = () => ((this.sing()));
			return obj;
		}
		attr(){
			return {...(super.attr()), "hyoo_slides_role": (this.role())};
		}
		style(){
			return {...(super.style()), "touch-action": "none"};
		}
		contents(next){
			if(next !== undefined) return next;
			return "";
		...
		Menu_item(id){
			...
			(obj.arg) = () => ({"slides": (this.menu_item_uri(id))});
			return obj;
		}
		menu_options(){
			return {
		...
		Page(id){
			...
			(obj.slide) = (next) => ((this.page_slide(id, next)));
			(obj.uri_base) = () => ((this.uri_base()));
			(obj.role) = () => ((this.role()));
	...
	($mol_mem(($.$hyoo_slides.prototype), "Source_link"));
	($mol_mem(($.$hyoo_slides.prototype), "Menu_items"));
	($mol_mem_key(($.$hyoo_slides.prototype), "page_slide"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_toggle_icon"));
	($mol_mem(($.$hyoo_slides.prototype), "speech_enabled"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_toggle"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_text"));
	($mol_mem(($.$hyoo_slides.prototype), "Paginator"));
	($mol_mem(($.$hyoo_slides.prototype), "Open_listener_icon"));
	($mol_mem(($.$hyoo_slides.prototype), "Open_listener"));
	($mol_mem(($.$hyoo_slides.prototype), "Lights"));
	($mol_mem(($.$hyoo_slides.prototype), "Close_icon"));
	($mol_mem(($.$hyoo_slides.prototype), "Close"));
	($mol_mem(($.$hyoo_slides.prototype), "Theme"));
	($mol_mem(($.$hyoo_slides.prototype), "slide"));
	($mol_mem(($.$hyoo_slides.prototype), "Nav"));
	($mol_mem(($.$hyoo_slides.prototype), "event_next"));
	($mol_mem(($.$hyoo_slides.prototype), "event_prev"));
	($mol_mem(($.$hyoo_slides.prototype), "Touch"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_next"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_next_auto"));
	($mol_mem(($.$hyoo_slides.prototype), "event_slide"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_slide"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_prev"));
	($mol_mem(($.$hyoo_slides.prototype), "event_start"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_start"));
	($mol_mem(($.$hyoo_slides.prototype), "event_end"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_end"));
	($mol_mem(($.$hyoo_slides.prototype), "event_about"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_about"));
	($mol_mem(($.$hyoo_slides.prototype), "event_repeat"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_repeat"));
	($mol_mem(($.$hyoo_slides.prototype), "event_speech_on"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_on"));
	($mol_mem(($.$hyoo_slides.prototype), "event_speech_off"));
	($mol_mem(($.$hyoo_slides.prototype), "Speech_off"));
	($mol_mem(($.$hyoo_slides.prototype), "event_lights_toggle"));
	($mol_mem(($.$hyoo_slides.prototype), "Lights_toggle"));
	($mol_mem(($.$hyoo_slides.prototype), "event_sing"));
	($mol_mem(($.$hyoo_slides.prototype), "Sing"));
	($mol_mem(($.$hyoo_slides.prototype), "contents"));
	($mol_mem(($.$hyoo_slides.prototype), "Menu"));
	($mol_mem_key(($.$hyoo_slides.prototype), "Menu_item"));
	($mol_mem(($.$hyoo_slides.prototype), "Loader"));
	($mol_mem_key(($.$hyoo_slides.prototype), "Page"));
