...
declare namespace $ {
    class $hyoo_slides extends $mol_view {
        ...
        page_slide(index: any, val?: any, force?: $mol_atom_force): any;
        uri_base(): string;
        listener_content(index: any): any[];
        speaker_content(index: any): any[];
        ...
        event_repeat(val?: any, force?: $mol_atom_force): any;
        speech_repeat(): any[];
        Speech_on(): $mol_speech;
        event_speech_on(val?: any, force?: $mol_atom_force): any;
        speech_on(): any[];
        Speech_off(): $mol_speech;
        event_speech_off(val?: any, force?: $mol_atom_force): any;
        speech_off(): any[];
        Lights_toggle(): $mol_speech;
        event_lights_toggle(val?: any, force?: $mol_atom_force): any;
        lights_toggle(): any[];
        Sing(): $mol_speech;
        event_sing(val?: any, force?: $mol_atom_force): any;
        sing(): any[];
    }
}
declare namespace $.$$ {
    class $hyoo_slides extends $.$hyoo_slides {
        ...
        title(): string;
        speaker_content(index: number): $mol_syntax_token[];
        listener_content(index: number): $mol_syntax_token[];
